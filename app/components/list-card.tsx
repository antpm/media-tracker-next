...
import { EditIcon, ViewIcon } from '@/public/icons/icons';
	...
	return (
		<>
			{image === '' ? (
				...
				<div className=" 2xl:w-3/4 flex flex-col md:flex-row mx-auto w-11/12 border-gray-500 shadow-lg shadow-black card p-2 min-h-60 md:h-56 h-56 items-center justify-evenly rounded-xl text-lg">
					...
					<div className="flex flex-col justify-around lg:w-1/2 w-full md:h-full h-2/3 text-center md:text-start mb-4">
					...
					<div className="flex md:flex-col flex-row justify-around items-center lg:w-1/6 w-full ml-2 lg:ml-0 md:h-3/4 h-fit">
						<button className="lg:hidden p-1 button transition-color duration-500 ease-in-out shadow-md shadow-black" onClick={viewDoc}>
							<div className="mx-4 items-center">
								<Image src={ViewIcon} alt="edit" width={24} height={24} className="float-left mr-2" />
								View
							</div>
						</button>
