	...
	return (
		<>
			{image === '' ? (
				...
				<div className=" 2xl:w-3/4 mx-auto w-11/12 border-gray-500 shadow-lg shadow-black card p-2 min-h-60 md:h-56 h-56 items-center justify-evenly rounded-xl text-lg">
